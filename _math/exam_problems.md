...
Здесь имеются ввиду матрицы, которые при повороте не меняются в том же смысле, как симметричные матрицы не меняются при транспонировании.

(а) Рассмотрим простую "вращательную" матрицу 2х2, она переходит в себя при вращении относительно центра:
...
У нее собственными значениями будут $%0$% и $%2a$%.

Для "вращательных" матриц следующего вида собственными значениями будут $%0, 2a_1, ..., 2a_n$%, это можно увидеть без характеристического многочлена, соответствующие пары строк просто будут становиться линейно-зависимыми.
...
То есть, это вид "вращательных" матриц из которых можно получить "вращательную" с заданными собственными значениями.
